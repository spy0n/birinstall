...
COIN_REPO='https://github.com/birake/birakecoin/releases/download/v1.0.3.0/birakecoin-1.0.3-x86_64-linux-gnu.tar.gz'
...
function compile_node() {
  ...
  echo -e "Remove the old $COIN_NAME files from the system"
